 ...
 * 「收支管理」UseCase 接线模块。
 *
 * [DeleteTransactionUseCase] 采用构造注入、类本身不带 [dagger.inject.Inject]，故在此通过
 * [Provides] 显式组装，供 [com.expfal.yunayu.ui.screen.transactionmanage.TransactionManageViewModel] 注入。
 */
@Module
